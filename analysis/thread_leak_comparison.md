...
## Contexto
A base `work` está alinhada com o release 5.3.8 e mantém o pipeline de logging original (fila + `std::ofstream`) descrito em `FatController.cpp`. 【F:src/FatController.cpp†L126-L205】
