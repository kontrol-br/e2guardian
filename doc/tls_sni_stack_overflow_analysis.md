...
1. **Validação estrita de limites** – cada passo da navegação dentro do *ClientHello* verifica se há bytes suficientes antes de ler ou avançar ponteiros. Caso contrário, a função retorna `NULL` sem tocar o *buffer*.
